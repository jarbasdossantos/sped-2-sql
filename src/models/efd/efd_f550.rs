...
use crate::schemas::efd_f550::dsl as schema;
use crate::schemas::efd_f550::table;
...
#[diesel(table_name = crate::schemas::efd_f550::dsl)]
pub struct EfdF550 {
    pub id: i32,
...
impl Model for EfdF550 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdF550>, Error> {
