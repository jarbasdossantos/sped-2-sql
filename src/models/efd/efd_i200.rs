...
use crate::schemas::efd_i200::dsl as schema;
use crate::schemas::efd_i200::table;
...
#[diesel(table_name = crate::schemas::efd_i200::dsl)]
pub struct EfdI200 {
    pub id: i32,
...
impl Model for EfdI200 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdI200>, Error> {
...
impl_display_fields!(EfdI200, [reg, num_campo, cod_det, vl_det, cod_cta, inf_comp]);
