...
use crate::schemas::efd_a100::dsl as schema;
use crate::schemas::efd_a100::table;
...
#[diesel(table_name = crate::schemas::efd_a100::dsl)]
pub struct EfdA100 {
    pub id: i32,
...
impl Model for EfdA100 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdA100>, Error> {
