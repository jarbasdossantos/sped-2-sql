...
use crate::schemas::efd_m300::dsl as schema;
use crate::schemas::efd_m300::table;
...
#[diesel(table_name = crate::schemas::efd_m300::dsl)]
pub struct EfdM300 {
    pub id: i32,
...
impl Model for EfdM300 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdM300>, Error> {
