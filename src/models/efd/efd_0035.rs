...
impl Model for Efd0035 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Efd0035>, Error> {
...
impl fmt::Display for Efd0035 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(Efd0035, [reg, cod_scp, nome_scp, inf_comp]);
register_model!(Efd0035, "0035");
