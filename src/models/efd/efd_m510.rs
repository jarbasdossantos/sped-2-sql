...
use crate::schemas::efd_m510::efd_m510::dsl as schema;
use crate::schemas::efd_m510::efd_m510::table;
...
#[diesel(table_name = crate::schemas::efd_m510::efd_m510::dsl)]
pub struct EfdM510 {
    pub id: i32,
...
impl Model for EfdM510 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<EfdM510>, Error> {
        Ok(table
