...
pub struct EfdI300 {
    ...
    pub cod_comp: Option<String>,
    pub vl_comp: Option<String>,
    pub cod_cta: Option<String>,
    pub inf_comp: Option<String>,
}

#[async_trait]
impl Model for EfdI300 {
    fn new(
        fields: Vec<&str>,
        new_id: Option<i32>,
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdI300>, Error> {
...
impl fmt::Display for EfdI300 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdI300, [reg, cod_comp, vl_comp, cod_cta, inf_comp]);
register_model!(EfdI300, "i300");
