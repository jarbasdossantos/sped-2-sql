...
use crate::schemas::efd_c001::dsl as schema;
use crate::schemas::efd_c001::table;
...
#[diesel(table_name = crate::schemas::efd_c001::dsl)]
pub struct EfdC001 {
    pub id: i32,
...
impl Model for EfdC001 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC001>, Error> {
