...
use crate::schemas::efd_m205::dsl as schema;
use crate::schemas::efd_m205::table;
...
#[diesel(table_name = crate::schemas::efd_m205::dsl)]
pub struct EfdM205 {
    pub id: i32,
...
impl Model for EfdM205 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdM205>, Error> {
