...
use crate::schemas::efd_d500::dsl as schema;
use crate::schemas::efd_d500::table;
...
#[diesel(table_name = crate::schemas::efd_d500::dsl)]
pub struct EfdD500 {
    pub id: i32,
...
impl Model for EfdD500 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD500>, Error> {
