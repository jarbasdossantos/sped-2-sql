...
use crate::schemas::efd_0450::efd_0450::dsl as schema;
use crate::schemas::efd_0450::efd_0450::table;
...
#[diesel(table_name = crate::schemas::efd_0450::efd_0450::dsl)]
pub struct Efd0450 {
    pub id: i32,
...
impl Model for Efd0450 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<Efd0450>, Error> {
        Ok(table
