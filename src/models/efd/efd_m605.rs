...
use crate::schemas::efd_m605::dsl as schema;
use crate::schemas::efd_m605::table;
...
#[diesel(table_name = crate::schemas::efd_m605::dsl)]
pub struct EfdM605 {
    pub id: i32,
...
impl Model for EfdM605 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdM605>, Error> {
