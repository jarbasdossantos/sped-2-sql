...
use crate::schemas::efd_c199::dsl as schema;
use crate::schemas::efd_c199::table;
...
#[diesel(table_name = crate::schemas::efd_c199::dsl)]
pub struct EfdC199 {
    pub id: i32,
...
impl Model for EfdC199 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC199>, Error> {
...
impl fmt::Display for EfdC199 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdC199, [reg, cod_doc_imp, num_doc_imp, vl_pis_imp, vl_cofins_imp, num_acdraw]);
register_model!(EfdC199, "c199");
