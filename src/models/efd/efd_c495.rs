...
use crate::schemas::efd_c495::dsl as schema;
use crate::schemas::efd_c495::table;
...
#[diesel(table_name = crate::schemas::efd_c495::dsl)]
pub struct EfdC495 {
    pub id: i32,
...
impl Model for EfdC495 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC495>, Error> {
