...
use crate::schemas::efd_m105::efd_m105::dsl as schema;
use crate::schemas::efd_m105::efd_m105::table;
...
#[diesel(table_name = crate::schemas::efd_m105::efd_m105::dsl)]
pub struct EfdM105 {
    pub id: i32,
...
impl Model for EfdM105 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<EfdM105>, Error> {
