...
use crate::schemas::efd_c380::dsl as schema;
use crate::schemas::efd_c380::table;
...
#[diesel(table_name = crate::schemas::efd_c380::dsl)]
pub struct EfdC380 {
    pub id: i32,
    ...
    pub vl_doc_canc: Option<String>,
}

#[async_trait]
impl Model for EfdC380 {
    fn new(
        fields: Vec<&str>,
        new_id: Option<i32>,
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC380>, Error> {
...
impl fmt::Display for EfdC380 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdC380, [reg, cod_mod, dt_doc_ini, dt_doc_fin, num_doc_ini, num_doc_fin, vl_doc, vl_doc_canc]);
register_model!(EfdC380, "c380");
