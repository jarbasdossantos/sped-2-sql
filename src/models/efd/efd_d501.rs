...
use crate::schemas::efd_d501::dsl as schema;
use crate::schemas::efd_d501::table;
...
#[diesel(table_name = crate::schemas::efd_d501::dsl)]
pub struct EfdD501 {
    pub id: i32,
...
impl Model for EfdD501 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD501>, Error> {
