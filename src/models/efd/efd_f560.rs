...
use crate::schemas::efd_f560::dsl as schema;
use crate::schemas::efd_f560::table;
...
#[diesel(table_name = crate::schemas::efd_f560::dsl)]
pub struct EfdF560 {
    pub id: i32,
...
impl Model for EfdF560 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdF560>, Error> {
