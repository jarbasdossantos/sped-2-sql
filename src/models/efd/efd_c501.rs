...
use crate::schemas::efd_c501::dsl as schema;
use crate::schemas::efd_c501::table;
...
#[diesel(table_name = crate::schemas::efd_c501::dsl)]
pub struct EfdC501 {
    pub id: i32,
...
impl Model for EfdC501 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC501>, Error> {
