...
use crate::schemas::efd_c191::dsl as schema;
use crate::schemas::efd_c191::table;
...
#[diesel(table_name = crate::schemas::efd_c191::dsl)]
pub struct EfdC191 {
    pub id: i32,
...
impl Model for EfdC191 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC191>, Error> {
