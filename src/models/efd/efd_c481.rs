...
use crate::schemas::efd_c481::dsl as schema;
use crate::schemas::efd_c481::table;
...
#[diesel(table_name = crate::schemas::efd_c481::dsl)]
pub struct EfdC481 {
    pub id: i32,
...
impl Model for EfdC481 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC481>, Error> {
