...
use crate::schemas::efd_f100::dsl as schema;
use crate::schemas::efd_f100::table;
...
#[diesel(table_name = crate::schemas::efd_f100::dsl)]
pub struct EfdF100 {
    pub id: i32,
...
impl Model for EfdF100 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdF100>, Error> {
