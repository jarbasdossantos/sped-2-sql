...
use crate::schemas::efd_c381::efd_c381::dsl as schema;
use crate::schemas::efd_c381::efd_c381::table;
...
#[diesel(table_name = crate::schemas::efd_c381::efd_c381::dsl)]
pub struct EfdC381 {
    pub id: i32,
...
impl Model for EfdC381 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<EfdC381>, Error> {
        Ok(table
            .filter(schema::file_id.eq(&file_id))
            .filter(schema::parent_id.eq(parent_id.expect("Invalid parent id")))
            .select(EfdC381::as_select())
            .load(&mut DB_POOL
                .get().unwrap())?)
    }
...
impl fmt::Display for EfdC381 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdC381, [reg, cst_pis, cod_item, vl_item, vl_bc_pis, aliq_pis, quant_bc_pis, aliq_pis_quant, vl_pis, cod_cta]);
register_model!(EfdC381, "c381");
