...
use crate::schemas::efd_c381::dsl as schema;
use crate::schemas::efd_c381::table;
...
#[diesel(table_name = crate::schemas::efd_c381::dsl)]
pub struct EfdC381 {
    pub id: i32,
...
impl Model for EfdC381 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC381>, Error> {
