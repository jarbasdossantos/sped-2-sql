...
use crate::schemas::efd_f500::dsl as schema;
use crate::schemas::efd_f500::table;
...
#[diesel(table_name = crate::schemas::efd_f500::dsl)]
pub struct EfdF500 {
    pub id: i32,
...
impl Model for EfdF500 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdF500>, Error> {
...
impl fmt::Display for EfdF500 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdF500, [reg, vl_rec_caixa, cst_pis, vl_desc_pis, vl_bc_pis, aliq_pis, vl_pis, cst_cofins, vl_desc_cofins, vl_bc_cofins, aliq_cofins, vl_cofins, cod_mod, cfop, cod_cta, info_compl]);
register_model!(EfdF500, "f500");
