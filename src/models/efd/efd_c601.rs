...
use crate::schemas::efd_c601::dsl as schema;
use crate::schemas::efd_c601::table;
...
#[diesel(table_name = crate::schemas::efd_c601::dsl)]
pub struct EfdC601 {
    pub id: i32,
...
impl Model for EfdC601 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC601>, Error> {
