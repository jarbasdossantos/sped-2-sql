...
use crate::schemas::efd_c170::dsl as schema;
use crate::schemas::efd_c170::table;
...
#[diesel(table_name = crate::schemas::efd_c170::dsl)]
pub struct EfdC170 {
    pub id: i32,
...
impl Model for EfdC170 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC170>, Error> {
