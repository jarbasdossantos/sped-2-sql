...
use crate::schemas::efd_i100::dsl as schema;
use crate::schemas::efd_i100::table;
...
#[diesel(table_name = crate::schemas::efd_i100::dsl)]
pub struct EfdI100 {
    pub id: i32,
...
impl Model for EfdI100 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdI100>, Error> {
