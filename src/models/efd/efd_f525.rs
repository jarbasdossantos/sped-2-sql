...
use crate::schemas::efd_f525::efd_f525::dsl as schema;
use crate::schemas::efd_f525::efd_f525::table;
...
#[diesel(table_name = crate::schemas::efd_f525::efd_f525::dsl)]
pub struct EfdF525 {
    pub id: i32,
...
impl_display_fields!(
    EfdF525,
    [
        reg, vl_rec, ind_rec, cnpj_cpf, num_doc, cod_item, vl_rec_det, cst_pis, cst_cofins,
        info_compl, cod_cta
    ]
);
