...
use crate::schemas::efd_c505::dsl as schema;
use crate::schemas::efd_c505::table;
...
#[diesel(table_name = crate::schemas::efd_c505::dsl)]
pub struct EfdC505 {
    pub id: i32,
...
impl Model for EfdC505 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC505>, Error> {
