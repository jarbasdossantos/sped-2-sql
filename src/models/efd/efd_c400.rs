...
use crate::schemas::efd_c400::dsl as schema;
use crate::schemas::efd_c400::table;
...
#[diesel(table_name = crate::schemas::efd_c400::dsl)]
pub struct EfdC400 {
    pub id: i32,
...
impl Model for EfdC400 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC400>, Error> {
