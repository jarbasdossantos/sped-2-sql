...
use crate::schemas::efd_m410::efd_m410::dsl as schema;
use crate::schemas::efd_m410::efd_m410::table;
...
#[diesel(table_name = crate::schemas::efd_m410::efd_m410::dsl)]
pub struct EfdM410 {
    pub id: i32,
...
impl Model for EfdM410 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<EfdM410>, Error> {
