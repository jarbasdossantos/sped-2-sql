...
use crate::schemas::efd_0145::efd_0145::dsl as schema;
use crate::schemas::efd_0145::efd_0145::table;
...
#[diesel(table_name = crate::schemas::efd_0145::efd_0145::dsl)]
pub struct Efd0145 {
    pub id: i32,
...
impl Model for Efd0145 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<Efd0145>, Error> {
