...
use crate::schemas::efd_m630::dsl as schema;
use crate::schemas::efd_m630::table;
...
#[diesel(table_name = crate::schemas::efd_m630::dsl)]
pub struct EfdM630 {
    pub id: i32,
...
impl Model for EfdM630 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdM630>, Error> {
