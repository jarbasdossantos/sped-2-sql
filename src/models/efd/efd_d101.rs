...
use crate::schemas::efd_d101::dsl as schema;
use crate::schemas::efd_d101::table;
...
#[diesel(table_name = crate::schemas::efd_d101::dsl)]
pub struct EfdD101 {
    pub id: i32,
...
impl Model for EfdD101 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD101>, Error> {
...
impl fmt::Display for EfdD101 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdD101, [reg, ind_nat_frt, vl_item, cst_pis, nat_bc_cred, vl_bc_pis, aliq_pis, vl_pis, cod_cta]);
register_model!(EfdD101, "d101");
