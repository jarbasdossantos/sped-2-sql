...
use crate::schemas::efd_f200::dsl as schema;
use crate::schemas::efd_f200::table;
...
#[diesel(table_name = crate::schemas::efd_f200::dsl)]
pub struct EfdF200 {
    pub id: i32,
...
impl Model for EfdF200 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdF200>, Error> {
