...
use crate::schemas::efd_i010::dsl as schema;
use crate::schemas::efd_i010::table;
...
#[diesel(table_name = crate::schemas::efd_i010::dsl)]
pub struct EfdI010 {
    pub id: i32,
...
impl Model for EfdI010 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdI010>, Error> {
