...
use crate::schemas::efd_f600::dsl as schema;
use crate::schemas::efd_f600::table;
...
#[diesel(table_name = crate::schemas::efd_f600::dsl)]
pub struct EfdF600 {
    pub id: i32,
...
impl Model for EfdF600 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdF600>, Error> {
