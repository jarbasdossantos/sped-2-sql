...
use crate::schemas::efd_c605::dsl as schema;
use crate::schemas::efd_c605::table;
...
#[diesel(table_name = crate::schemas::efd_c605::dsl)]
pub struct EfdC605 {
    pub id: i32,
...
impl Model for EfdC605 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC605>, Error> {
