...
use crate::schemas::efd_m110::dsl as schema;
use crate::schemas::efd_m110::table;
...
#[diesel(table_name = crate::schemas::efd_m110::dsl)]
pub struct EfdM110 {
    pub id: i32,
...
impl Model for EfdM110 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdM110>, Error> {
