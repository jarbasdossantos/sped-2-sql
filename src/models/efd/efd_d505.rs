...
use crate::schemas::efd_d505::dsl as schema;
use crate::schemas::efd_d505::table;
...
#[diesel(table_name = crate::schemas::efd_d505::dsl)]
pub struct EfdD505 {
    pub id: i32,
...
impl Model for EfdD505 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD505>, Error> {
