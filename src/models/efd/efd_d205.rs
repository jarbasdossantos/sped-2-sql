...
use crate::schemas::efd_d205::dsl as schema;
use crate::schemas::efd_d205::table;
...
#[diesel(table_name = crate::schemas::efd_d205::dsl)]
pub struct EfdD205 {
    pub id: i32,
...
impl Model for EfdD205 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD205>, Error> {
