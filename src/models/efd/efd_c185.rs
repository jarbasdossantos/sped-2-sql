...
use crate::schemas::efd_c185::dsl as schema;
use crate::schemas::efd_c185::table;
...
#[diesel(table_name = crate::schemas::efd_c185::dsl)]
pub struct EfdC185 {
    pub id: i32,
...
impl Model for EfdC185 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC185>, Error> {
