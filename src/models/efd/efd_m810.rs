...
use crate::schemas::efd_m810::dsl as schema;
use crate::schemas::efd_m810::table;
...
#[diesel(table_name = crate::schemas::efd_m810::dsl)]
pub struct EfdM810 {
    pub id: i32,
...
impl Model for EfdM810 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdM810>, Error> {
...
impl fmt::Display for EfdM810 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdM810, [reg, nat_rec, vl_rec, cod_cta, desc_compl]);
register_model!(EfdM810, "m810");
