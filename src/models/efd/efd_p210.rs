...
use crate::schemas::efd_p210::dsl as schema;
use crate::schemas::efd_p210::table;
...
#[diesel(table_name = crate::schemas::efd_p210::dsl)]
pub struct EfdP210 {
    pub id: i32,
...
impl Model for EfdP210 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdP210>, Error> {
...
impl fmt::Display for EfdP210 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdP210, [reg, ind_aj, vl_aj, cod_aj, num_doc, descr_aj, dt_ref]);
register_model!(EfdP210, "p210");
