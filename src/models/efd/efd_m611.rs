...
use crate::schemas::efd_m611::dsl as schema;
use crate::schemas::efd_m611::table;
...
#[diesel(table_name = crate::schemas::efd_m611::dsl)]
pub struct EfdM611 {
    pub id: i32,
...
impl Model for EfdM611 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdM611>, Error> {
