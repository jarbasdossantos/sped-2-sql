...
use crate::schemas::efd_c491::dsl as schema;
use crate::schemas::efd_c491::table;
...
#[diesel(table_name = crate::schemas::efd_c491::dsl)]
pub struct EfdC491 {
    pub id: i32,
...
impl Model for EfdC491 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC491>, Error> {
