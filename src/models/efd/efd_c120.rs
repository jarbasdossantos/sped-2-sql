...
use crate::schemas::efd_c120::dsl as schema;
use crate::schemas::efd_c120::table;
...
#[diesel(table_name = crate::schemas::efd_c120::dsl)]
pub struct EfdC120 {
    pub id: i32,
...
impl Model for EfdC120 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC120>, Error> {
