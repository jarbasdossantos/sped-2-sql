...
use crate::schemas::efd_1500::dsl as schema;
use crate::schemas::efd_1500::table;
...
#[diesel(table_name = crate::schemas::efd_1500::dsl)]
pub struct Efd1500 {
    pub id: i32,
...
impl Model for Efd1500 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Efd1500>, Error> {
