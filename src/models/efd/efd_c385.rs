...
use crate::schemas::efd_c385::dsl as schema;
use crate::schemas::efd_c385::table;
...
#[diesel(table_name = crate::schemas::efd_c385::dsl)]
pub struct EfdC385 {
    pub id: i32,
...
impl Model for EfdC385 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC385>, Error> {
