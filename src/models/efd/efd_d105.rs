...
use crate::schemas::efd_d105::dsl as schema;
use crate::schemas::efd_d105::table;
...
#[diesel(table_name = crate::schemas::efd_d105::dsl)]
pub struct EfdD105 {
    pub id: i32,
...
impl Model for EfdD105 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD105>, Error> {
