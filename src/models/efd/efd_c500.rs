...
use crate::schemas::efd_c500::dsl as schema;
use crate::schemas::efd_c500::table;
...
#[diesel(table_name = crate::schemas::efd_c500::dsl)]
pub struct EfdC500 {
    pub id: i32,
...
impl Model for EfdC500 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC500>, Error> {
