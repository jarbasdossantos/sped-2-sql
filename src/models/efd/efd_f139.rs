...
use crate::schemas::efd_f139::efd_f139::dsl as schema;
use crate::schemas::efd_f139::efd_f139::table;
...
#[diesel(table_name = crate::schemas::efd_f139::efd_f139::dsl)]
pub struct EfdF139 {
    pub id: i32,
...
impl Model for EfdF139 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<EfdF139>, Error> {
