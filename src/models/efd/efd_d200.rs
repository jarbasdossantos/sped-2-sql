...
use crate::schemas::efd_d200::table;
...
#[diesel(table_name = crate::schemas::efd_d200::dsl)]
pub struct EfdD200 {
    pub id: i32,
...
impl Model for EfdD200 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD200>, Error> {
