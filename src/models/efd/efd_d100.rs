...
use crate::schemas::efd_d100::dsl as schema;
use crate::schemas::efd_d100::table;
...
#[diesel(table_name = crate::schemas::efd_d100::dsl)]
pub struct EfdD100 {
    pub id: i32,
...
impl Model for EfdD100 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD100>, Error> {
