...
use crate::schemas::efd_d600::dsl as schema;
use crate::schemas::efd_d600::table;
...
#[diesel(table_name = crate::schemas::efd_d600::dsl)]
pub struct EfdD600 {
    pub id: i32,
...
impl Model for EfdD600 {
    fn new(
        ...
        EfdD600 {
            ...
            ind_rec: get_field(&fields, 6),
            qtd_cons: get_field(&fields, 7),
            dt_doc_ini: get_field(&fields, 8),
            dt_doc_fin: get_field(&fields, 9),
            vl_doc: get_field(&fields, 10),
            vl_desc: get_field(&fields, 11),
            vl_serv: get_field(&fields, 12),
            vl_serv_nt: get_field(&fields, 13),
            vl_terc: get_field(&fields, 14),
            vl_da: get_field(&fields, 15),
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD600>, Error> {
