...
use crate::schemas::efd_f150::efd_f150::dsl as schema;
use crate::schemas::efd_f150::efd_f150::table;
...
#[diesel(table_name = crate::schemas::efd_f150::efd_f150::dsl)]
pub struct EfdF150 {
    pub id: i32,
...
impl Model for EfdF150 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<EfdF150>, Error> {
