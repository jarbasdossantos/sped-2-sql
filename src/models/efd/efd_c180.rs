...
use crate::schemas::efd_c180::dsl as schema;
use crate::schemas::efd_c180::table;
...
#[diesel(table_name = crate::schemas::efd_c180::dsl)]
pub struct EfdC180 {
    pub id: i32,
...
impl Model for EfdC180 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC180>, Error> {
