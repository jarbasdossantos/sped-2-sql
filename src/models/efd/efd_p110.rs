...
use crate::schemas::efd_p110::dsl as schema;
use crate::schemas::efd_p110::table;
...
#[diesel(table_name = crate::schemas::efd_p110::dsl)]
pub struct EfdP110 {
    pub id: i32,
...
impl Model for EfdP110 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdP110>, Error> {
