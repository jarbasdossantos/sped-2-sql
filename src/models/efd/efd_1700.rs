...
use crate::schemas::efd_1700::dsl as schema;
use crate::schemas::efd_1700::table;
...
#[diesel(table_name = crate::schemas::efd_1700::dsl)]
pub struct Efd1700 {
    pub id: i32,
...
impl Model for Efd1700 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Efd1700>, Error> {
