...
use crate::schemas::efd_1700::efd_1700::dsl as schema;
use crate::schemas::efd_1700::efd_1700::table;
...
#[diesel(table_name = crate::schemas::efd_1700::efd_1700::dsl)]
pub struct Efd1700 {
    pub id: i32,
...
impl Model for Efd1700 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<Efd1700>, Error> {
        Ok(table
            .filter(schema::file_id.eq(&file_id))
            .filter(schema::parent_id.eq(parent_id.expect("Invalid parent id")))
            .select(Efd1700::as_select())
            .load(&mut DB_POOL
                .get().unwrap())?)
    }
...
impl fmt::Display for Efd1700 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(Efd1700, [reg, ind_nat_ret, pr_rec_ret, vl_ret_apu, vl_ret_ded, vl_ret_per, vl_ret_dcomp, sld_ret]);
register_model!(Efd1700, "1700");
