...
use crate::schemas::efd_f510::dsl as schema;
use crate::schemas::efd_f510::table;
...
#[diesel(table_name = crate::schemas::efd_f510::dsl)]
pub struct EfdF510 {
    pub id: i32,
...
impl Model for EfdF510 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdF510>, Error> {
