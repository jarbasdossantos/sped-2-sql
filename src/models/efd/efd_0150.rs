...
use crate::schemas::efd_0150::dsl as schema;
use crate::schemas::efd_0150::table;
...
#[diesel(table_name = crate::schemas::efd_0150::dsl)]
pub struct Efd0150 {
    pub id: i32,
...
impl Model for Efd0150 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Efd0150>, Error> {
...
impl_display_fields!(Efd0150, [reg, cod_part, nome, cod_pais, cnpj, cpf, ie, cod_mun, suframa, end, num, compl, bairro]);
