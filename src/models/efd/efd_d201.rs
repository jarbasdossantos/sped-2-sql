...
use crate::schemas::efd_d201::efd_d201::dsl as schema;
use crate::schemas::efd_d201::efd_d201::table;
...
#[diesel(table_name = crate::schemas::efd_d201::efd_d201::dsl)]
pub struct EfdD201 {
    pub id: i32,
...
impl Model for EfdD201 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<EfdD201>, Error> {
        Ok(table
