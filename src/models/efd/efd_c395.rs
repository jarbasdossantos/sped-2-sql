...
use crate::schemas::efd_c395::dsl as schema;
use crate::schemas::efd_c395::table;
...
#[diesel(table_name = crate::schemas::efd_c395::dsl)]
pub struct EfdC395 {
    pub id: i32,
...
impl Model for EfdC395 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdC395>, Error> {
