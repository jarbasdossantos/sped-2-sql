...
use crate::schemas::efd_d605::dsl as schema;
use crate::schemas::efd_d605::table;
...
#[diesel(table_name = crate::schemas::efd_d605::dsl)]
pub struct EfdD605 {
    pub id: i32,
...
impl Model for EfdD605 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<EfdD605>, Error> {
...
impl fmt::Display for EfdD605 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(EfdD605, [reg, cod_class, vl_item, vl_desc, cst_cofins, vl_bc_cofins, aliq_cofins, vl_cofins, cod_cta]);
register_model!(EfdD605, "d605");
