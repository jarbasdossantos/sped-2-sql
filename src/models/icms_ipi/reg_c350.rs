...
use crate::schemas::reg_c350::reg_c350::dsl as schema;
use crate::schemas::reg_c350::reg_c350::table;
...
#[diesel(table_name = crate::schemas::reg_c350::reg_c350::dsl)]
pub struct RegC350 {
    pub id: i32,
...
impl_display_fields!(
    RegC350,
    [
        reg, ser, sub_ser, num_doc, dt_doc, cnpj_cpf, vl_merc, vl_doc, vl_desc, vl_pis, vl_cofis,
        cod_cta
    ]
);
