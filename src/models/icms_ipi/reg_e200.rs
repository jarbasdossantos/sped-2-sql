...
use crate::schemas::reg_e200::dsl as schema;
use crate::schemas::reg_e200::table;
...
#[diesel(table_name = crate::schemas::reg_e200::dsl)]
pub struct RegE200 {
    pub id: i32,
...
impl Model for RegE200 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegE200>, Error> {
