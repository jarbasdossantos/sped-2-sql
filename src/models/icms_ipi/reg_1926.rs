...
use crate::schemas::reg_1926::reg_1926::dsl as schema;
use crate::schemas::reg_1926::reg_1926::table;
...
#[diesel(table_name = crate::schemas::reg_1926::reg_1926::dsl)]
pub struct Reg1926 {
    pub id: i32,
...
impl Model for Reg1926 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<Reg1926>, Error> {
