...
use crate::schemas::reg_e220::reg_e220::dsl as schema;
use crate::schemas::reg_e220::reg_e220::table;
...
#[diesel(table_name = crate::schemas::reg_e220::reg_e220::dsl)]
pub struct RegE220 {
    pub id: i32,
...
impl Model for RegE220 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegE220>, Error> {
