...
use crate::schemas::reg_c425::reg_c425::dsl as schema;
use crate::schemas::reg_c425::reg_c425::table;
...
#[diesel(table_name = crate::schemas::reg_c425::reg_c425::dsl)]
pub struct RegC425 {
    pub id: i32,
...
impl_display_fields!(
    RegC425,
    [reg, cod_item, qtd, unid, vl_item, vl_pis, vl_cofins]
);
