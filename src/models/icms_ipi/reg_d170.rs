...
use crate::schemas::reg_d170::dsl as schema;
use crate::schemas::reg_d170::table;
...
#[diesel(table_name = crate::schemas::reg_d170::dsl)]
pub struct RegD170 {
    pub id: i32,
...
impl Model for RegD170 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegD170>, Error> {
...
impl_display_fields!(RegD170, [reg, cod_part_consg, cod_part_red, cod_mun_orig, cod_mun_dest, otm, ind_nat_frt, vl_liq_frt, vl_gris, vl_pdg, vl_out, vl_frt, veic_id, uf_id]);
