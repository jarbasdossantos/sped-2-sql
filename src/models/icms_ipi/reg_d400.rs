...
use crate::schemas::reg_d400::reg_d400::dsl as schema;
use crate::schemas::reg_d400::reg_d400::table;
...
#[diesel(table_name = crate::schemas::reg_d400::reg_d400::dsl)]
pub struct RegD400 {
    pub id: i32,
...
impl_display_fields!(
    RegD400,
    [
        reg, cod_part, cod_mod, cod_sit, ser, sub, num_doc, dt_doc, vl_doc, vl_desc, vl_serv,
        vl_bc_icms, vl_icms, vl_pis, vl_cofins, cod_cta
    ]
);
