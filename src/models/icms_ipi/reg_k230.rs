...
use crate::schemas::reg_k230::dsl as schema;
use crate::schemas::reg_k230::table;
...
#[diesel(table_name = crate::schemas::reg_k230::dsl)]
pub struct RegK230 {
    pub id: i32,
...
impl Model for RegK230 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegK230>, Error> {
...
impl_display_fields!(RegK230, [reg, dt_ini_op, dt_fin_op, cod_doc_op, cod_item, qtd_enc]);
