...
use crate::schemas::reg_e250::reg_e250::dsl as schema;
use crate::schemas::reg_e250::reg_e250::table;
...
#[diesel(table_name = crate::schemas::reg_e250::reg_e250::dsl)]
pub struct RegE250 {
    pub id: i32,
...
impl_display_fields!(
    RegE250,
    [reg, cod_or, vl_or, dt_vcto, cod_rec, num_proc, ind_proc, proc_, txt_compl, mes_ref]
);
