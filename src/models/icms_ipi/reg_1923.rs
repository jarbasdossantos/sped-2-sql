...
use crate::schemas::reg_1923::reg_1923::dsl as schema;
use crate::schemas::reg_1923::reg_1923::table;
...
#[diesel(table_name = crate::schemas::reg_1923::reg_1923::dsl)]
pub struct Reg1923 {
    pub id: i32,
...
impl_display_fields!(
    Reg1923,
    [reg, cod_part, cod_mod, ser, sub, num_doc, dt_doc, cod_item, vl_aj_item]
);
