...
use crate::schemas::reg_1600::dsl as schema;
use crate::schemas::reg_1600::table;
...
#[diesel(table_name = crate::schemas::reg_1600::dsl)]
pub struct Reg1600 {
    pub id: i32,
...
impl Model for Reg1600 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Reg1600>, Error> {
