...
use crate::schemas::reg_c165::reg_c165::dsl as schema;
use crate::schemas::reg_c165::reg_c165::table;
...
#[diesel(table_name = crate::schemas::reg_c165::reg_c165::dsl)]
pub struct RegC165 {
    pub id: i32,
...
impl_display_fields!(
    RegC165,
    [
        reg, cod_part, veic_id, cod_aut, nr_passe, hora, temper, qtd_vol, peso_brt, peso_liq,
        nom_mot, cpf, uf_id
    ]
);
