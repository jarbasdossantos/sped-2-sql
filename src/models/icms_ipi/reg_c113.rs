...
use crate::schemas::reg_c113::reg_c113::dsl as schema;
use crate::schemas::reg_c113::reg_c113::table;
...
#[diesel(table_name = crate::schemas::reg_c113::reg_c113::dsl)]
pub struct RegC113 {
    pub id: i32,
...
impl Model for RegC113 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegC113>, Error> {
...
impl_display_fields!(
    RegC113,
    [reg, ind_oper, ind_emit, cod_part, cod_mod, ser, sub, num_doc, dt_doc]
);
