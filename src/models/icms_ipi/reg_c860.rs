...
use crate::schemas::reg_c860::reg_c860::dsl as schema;
use crate::schemas::reg_c860::reg_c860::table;
...
#[diesel(table_name = crate::schemas::reg_c860::reg_c860::dsl)]
pub struct RegC860 {
    pub id: i32,
...
impl Model for RegC860 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegC860>, Error> {
...
impl fmt::Display for RegC860 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(RegC860, [reg, cod_mod, nr_sat, dt_doc, doc_ini, doc_fim]);
register_model!(RegC860, "c860");
