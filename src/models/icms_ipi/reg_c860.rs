...
use crate::schemas::reg_c860::dsl as schema;
use crate::schemas::reg_c860::table;
...
#[diesel(table_name = crate::schemas::reg_c860::dsl)]
pub struct RegC860 {
    pub id: i32,
...
impl Model for RegC860 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegC860>, Error> {
