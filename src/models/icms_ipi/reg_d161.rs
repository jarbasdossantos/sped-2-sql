...
use crate::schemas::reg_d161::reg_d161::dsl as schema;
use crate::schemas::reg_d161::reg_d161::table;
...
#[diesel(table_name = crate::schemas::reg_d161::reg_d161::dsl)]
pub struct RegD161 {
    pub id: i32,
...
impl Model for RegD161 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegD161>, Error> {
