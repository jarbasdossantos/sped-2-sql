...
use crate::schemas::reg_c179::reg_c179::dsl as schema;
use crate::schemas::reg_c179::reg_c179::table;
...
#[diesel(table_name = crate::schemas::reg_c179::reg_c179::dsl)]
pub struct RegC179 {
    pub id: i32,
...
impl Model for RegC179 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegC179>, Error> {
