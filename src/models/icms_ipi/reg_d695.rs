...
use crate::schemas::reg_d695::reg_d695::dsl as schema;
use crate::schemas::reg_d695::reg_d695::table;
...
#[diesel(table_name = crate::schemas::reg_d695::reg_d695::dsl)]
pub struct RegD695 {
    pub id: i32,
...
impl Model for RegD695 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegD695>, Error> {
