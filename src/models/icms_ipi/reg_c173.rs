...
use crate::schemas::reg_c173::reg_c173::dsl as schema;
use crate::schemas::reg_c173::reg_c173::table;
...
#[diesel(table_name = crate::schemas::reg_c173::reg_c173::dsl)]
pub struct RegC173 {
    pub id: i32,
...
impl_display_fields!(
    RegC173,
    [reg, lote_med, qtd_item, dt_fab, dt_val, ind_med, tp_prod, vl_tab_max]
);
