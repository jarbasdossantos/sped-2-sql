...
use crate::schemas::reg_c850::reg_c850::dsl as schema;
use crate::schemas::reg_c850::reg_c850::table;
...
#[diesel(table_name = crate::schemas::reg_c850::reg_c850::dsl)]
pub struct RegC850 {
    pub id: i32,
...
impl_display_fields!(
    RegC850,
    [reg, cst_icms, cfop, aliq_icms, vl_opr, vl_bc_icms, vl_icms, cod_obs]
);
