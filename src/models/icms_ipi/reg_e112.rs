...
use crate::schemas::reg_e112::reg_e112::dsl as schema;
use crate::schemas::reg_e112::reg_e112::table;
...
#[diesel(table_name = crate::schemas::reg_e112::reg_e112::dsl)]
pub struct RegE112 {
    pub id: i32,
...
impl Model for RegE112 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegE112>, Error> {
...
impl fmt::Display for RegE112 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(RegE112, [reg, num_da, num_proc, ind_proc, proc_, txt_compl]);
register_model!(RegE112, "e112");
