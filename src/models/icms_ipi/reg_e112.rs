...
use crate::schemas::reg_e112::dsl as schema;
use crate::schemas::reg_e112::table;
...
#[diesel(table_name = crate::schemas::reg_e112::dsl)]
pub struct RegE112 {
    pub id: i32,
...
impl Model for RegE112 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegE112>, Error> {
