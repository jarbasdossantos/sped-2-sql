...
use crate::schemas::reg_d410::reg_d410::dsl as schema;
use crate::schemas::reg_d410::reg_d410::table;
...
#[diesel(table_name = crate::schemas::reg_d410::reg_d410::dsl)]
pub struct RegD410 {
    pub id: i32,
...
impl Model for RegD410 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegD410>, Error> {
