...
use crate::schemas::reg_d140::dsl as schema;
use crate::schemas::reg_d140::table;
...
#[diesel(table_name = crate::schemas::reg_d140::dsl)]
pub struct RegD140 {
    pub id: i32,
...
impl Model for RegD140 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegD140>, Error> {
...
impl_display_fields!(RegD140, [reg, cod_part_consg, cod_mun_orig, cod_mun_dest, ind_veic, veic_id, ind_nav, viagem, vl_frt_liq, vl_desp_port, vl_desp_car_desc, vl_out, vl_frt_brt, vl_frt_mm]);
