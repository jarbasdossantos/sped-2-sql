...
use crate::schemas::reg_0001::dsl as schema;
use crate::schemas::reg_0001::table;
...
#[diesel(table_name = crate::schemas::reg_0001::dsl)]
pub struct Reg0001 {
    pub id: i32,
...
impl Model for Reg0001 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Reg0001>, Error> {
