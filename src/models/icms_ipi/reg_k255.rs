...
use crate::schemas::reg_k255::reg_k255::dsl as schema;
use crate::schemas::reg_k255::reg_k255::table;
...
#[diesel(table_name = crate::schemas::reg_k255::reg_k255::dsl)]
pub struct RegK255 {
    pub id: i32,
...
impl Model for RegK255 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegK255>, Error> {
