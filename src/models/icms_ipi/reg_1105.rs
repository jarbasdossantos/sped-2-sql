...
use crate::schemas::reg_1105::reg_1105::dsl as schema;
use crate::schemas::reg_1105::reg_1105::table;
...
#[diesel(table_name = crate::schemas::reg_1105::reg_1105::dsl)]
pub struct Reg1105 {
    pub id: i32,
...
impl_display_fields!(
    Reg1105,
    [reg, cod_mod, ser, num_doc, chv_nfe, dt_doc, cod_item]
);
