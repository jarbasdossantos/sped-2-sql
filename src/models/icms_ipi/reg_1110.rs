...
use crate::schemas::reg_1110::dsl as schema;
use crate::schemas::reg_1110::table;
...
#[diesel(table_name = crate::schemas::reg_1110::dsl)]
pub struct Reg1110 {
    pub id: i32,
...
impl Model for Reg1110 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Reg1110>, Error> {
...
impl_display_fields!(Reg1110, [reg, cod_part, cod_mod, ser, num_doc, dt_doc, chv_nfe, nr_memo, qtd, unid]);
