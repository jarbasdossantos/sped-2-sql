...
use crate::schemas::reg_c140::reg_c140::dsl as schema;
use crate::schemas::reg_c140::reg_c140::table;
...
#[diesel(table_name = crate::schemas::reg_c140::reg_c140::dsl)]
pub struct RegC140 {
    pub id: i32,
...
impl_display_fields!(
    RegC140,
    [reg, ind_emit, ind_tit, desc_tit, num_tit, qtd_parc, vl_tit]
);
