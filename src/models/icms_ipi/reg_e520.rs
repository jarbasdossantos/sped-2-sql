...
use crate::schemas::reg_e520::dsl as schema;
use crate::schemas::reg_e520::table;
...
#[diesel(table_name = crate::schemas::reg_e520::dsl)]
pub struct RegE520 {
    pub id: i32,
...
impl Model for RegE520 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegE520>, Error> {
...
impl_display_fields!(RegE520, [reg, vl_sd_ant_ipi, vl_deb_ipi, vl_cred_ipi, vl_od_ipi, vl_oc_ipi, vl_sc_ipi, vl_sd_ipi]);
