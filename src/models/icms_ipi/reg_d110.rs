...
use crate::schemas::reg_d110::reg_d110::dsl as schema;
use crate::schemas::reg_d110::reg_d110::table;
...
#[diesel(table_name = crate::schemas::reg_d110::reg_d110::dsl)]
pub struct RegD110 {
    pub id: i32,
...
impl Model for RegD110 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegD110>, Error> {
