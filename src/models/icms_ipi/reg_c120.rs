...
use crate::schemas::reg_c120::dsl as schema;
use crate::schemas::reg_c120::table;
...
#[diesel(table_name = crate::schemas::reg_c120::dsl)]
pub struct RegC120 {
    pub id: i32,
...
impl Model for RegC120 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegC120>, Error> {
...
impl_display_fields!(RegC120, [reg, cod_doc_imp, num_doc_imp, pis_imp, cofins_imp, num_acdraw]);
