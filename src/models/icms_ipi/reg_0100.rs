...
use crate::schemas::reg_0100::dsl as schema;
use crate::schemas::reg_0100::table;
...
#[diesel(table_name = crate::schemas::reg_0100::dsl)]
pub struct Reg0100 {
    pub id: i32,
...
impl Model for Reg0100 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Reg0100>, Error> {
...
impl_display_fields!(Reg0100, [reg, nome, cpf, crc, cnpj, cep, endereco, num, compl, bairro, fone, fax, email, cod_mun]);
