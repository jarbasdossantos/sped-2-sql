...
use crate::schemas::reg_1100::reg_1100::dsl as schema;
use crate::schemas::reg_1100::reg_1100::table;
...
#[diesel(table_name = crate::schemas::reg_1100::reg_1100::dsl)]
pub struct Reg1100 {
    pub id: i32,
...
impl_display_fields!(
    Reg1100,
    [reg, ind_doc, nro_de, dt_de, nat_exp, nro_re, dt_re, chc_emb, dt_chc, dt_avb, tp_chc, pais]
);
