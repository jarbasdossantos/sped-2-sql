...
use crate::schemas::reg_0220::dsl as schema;
use crate::schemas::reg_0220::table;
...
#[diesel(table_name = crate::schemas::reg_0220::dsl)]
pub struct Reg0220 {
    pub id: i32,
...
impl Model for Reg0220 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Reg0220>, Error> {
