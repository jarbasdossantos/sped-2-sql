...
use crate::schemas::reg_c300::reg_c300::dsl as schema;
use crate::schemas::reg_c300::reg_c300::table;
...
#[diesel(table_name = crate::schemas::reg_c300::reg_c300::dsl)]
pub struct RegC300 {
    pub id: i32,
...
impl Model for RegC300 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegC300>, Error> {
