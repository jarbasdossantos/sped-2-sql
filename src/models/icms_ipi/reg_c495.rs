...
use crate::schemas::reg_c495::reg_c495::dsl as schema;
use crate::schemas::reg_c495::reg_c495::table;
...
#[diesel(table_name = crate::schemas::reg_c495::reg_c495::dsl)]
pub struct RegC495 {
    pub id: i32,
...
impl_display_fields!(
    RegC495,
    [
        reg, aliq_icms, cod_item, qtd, qtd_canc, unid, vl_item, vl_desc, vl_canc, vl_acmo,
        vl_bc_icms, vl_icms, vl_isen, vl_nt, vl_icms_st
    ]
);
