...
use crate::schemas::reg_1922::dsl as schema;
use crate::schemas::reg_1922::table;
...
#[diesel(table_name = crate::schemas::reg_1922::dsl)]
pub struct Reg1922 {
    pub id: i32,
...
impl Model for Reg1922 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Reg1922>, Error> {
