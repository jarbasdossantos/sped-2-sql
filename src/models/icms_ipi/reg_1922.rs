...
use crate::schemas::reg_1922::reg_1922::dsl as schema;
use crate::schemas::reg_1922::reg_1922::table;
...
#[diesel(table_name = crate::schemas::reg_1922::reg_1922::dsl)]
pub struct Reg1922 {
    pub id: i32,
...
impl Model for Reg1922 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<Reg1922>, Error> {
...
impl fmt::Display for Reg1922 {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        self.display_format(f)
    }
}

impl_display_fields!(Reg1922, [reg, num_da, num_proc, ind_proc, proc_, txt_compl]);
register_model!(Reg1922, "1922");
