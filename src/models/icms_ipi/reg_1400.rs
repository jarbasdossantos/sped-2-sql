...
use crate::schemas::reg_1400::reg_1400::dsl as schema;
use crate::schemas::reg_1400::reg_1400::table;
...
#[diesel(table_name = crate::schemas::reg_1400::reg_1400::dsl)]
pub struct Reg1400 {
    pub id: i32,
...
impl Model for Reg1400 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<Reg1400>, Error> {
