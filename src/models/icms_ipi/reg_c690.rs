...
use crate::schemas::reg_c690::reg_c690::dsl as schema;
use crate::schemas::reg_c690::reg_c690::table;
...
#[diesel(table_name = crate::schemas::reg_c690::reg_c690::dsl)]
pub struct RegC690 {
    pub id: i32,
...
impl Model for RegC690 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegC690>, Error> {
