...
use crate::schemas::reg_c470::dsl as schema;
use crate::schemas::reg_c470::table;
...
#[diesel(table_name = crate::schemas::reg_c470::dsl)]
pub struct RegC470 {
    pub id: i32,
...
impl Model for RegC470 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegC470>, Error> {
...
impl_display_fields!(RegC470, [reg, cod_item, qtd, qtd_canc, unid, vl_item, cst_icms, cfop, aliq_icms, vl_pis, vl_cofins]);
