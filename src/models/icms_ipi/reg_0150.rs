...
use crate::schemas::reg_0150::reg_0150::dsl as schema;
use crate::schemas::reg_0150::reg_0150::table;
...
#[diesel(table_name = crate::schemas::reg_0150::reg_0150::dsl)]
pub struct Reg0150 {
    pub id: i32,
...
impl_display_fields!(
    Reg0150,
    [
        reg, cod_part, nome, cod_pais, cnpj, cpf, ie, cod_mun, suframa, endereco, num, compl,
        bairro
    ]
);
