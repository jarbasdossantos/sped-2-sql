...
use crate::schemas::reg_c114::dsl as schema;
use crate::schemas::reg_c114::table;
...
#[diesel(table_name = crate::schemas::reg_c114::dsl)]
pub struct RegC114 {
    pub id: i32,
...
impl Model for RegC114 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegC114>, Error> {
