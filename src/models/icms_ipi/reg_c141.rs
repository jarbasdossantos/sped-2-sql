...
use crate::schemas::reg_c141::reg_c141::dsl as schema;
use crate::schemas::reg_c141::reg_c141::table;
...
#[diesel(table_name = crate::schemas::reg_c141::reg_c141::dsl)]
pub struct RegC141 {
    pub id: i32,
...
impl Model for RegC141 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegC141>, Error> {
