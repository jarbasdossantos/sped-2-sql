...
use crate::schemas::reg_c321::dsl as schema;
use crate::schemas::reg_c321::table;
...
#[diesel(table_name = crate::schemas::reg_c321::dsl)]
pub struct RegC321 {
    pub id: i32,
...
impl Model for RegC321 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegC321>, Error> {
...
impl_display_fields!(RegC321, [reg, cod_item, qtd, unid, vl_item, vl_desc, vl_bc_icms, vl_icms, vl_pis, vl_cofins]);
