...
use crate::schemas::reg_d390::dsl as schema;
use crate::schemas::reg_d390::table;
...
#[diesel(table_name = crate::schemas::reg_d390::dsl)]
pub struct RegD390 {
    pub id: i32,
...
impl Model for RegD390 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegD390>, Error> {
...
impl_display_fields!(RegD390, [reg, cst_icms, cfop, aliq_icms, vl_opr, vl_bc_issqn, aliq_issqn, vl_issqn, vl_bc_icms, vl_icms, cod_obs]);
