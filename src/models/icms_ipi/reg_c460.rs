...
use crate::schemas::reg_c460::reg_c460::dsl as schema;
use crate::schemas::reg_c460::reg_c460::table;
...
#[diesel(table_name = crate::schemas::reg_c460::reg_c460::dsl)]
pub struct RegC460 {
    pub id: i32,
...
impl_display_fields!(
    RegC460,
    [reg, cod_mod, cod_sit, num_doc, dt_doc, vl_doc, vl_pis, vl_cofins, cpf_cnpj, nome_adq]
);
