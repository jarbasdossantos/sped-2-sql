...
use crate::schemas::reg_c700::dsl as schema;
use crate::schemas::reg_c700::table;
...
#[diesel(table_name = crate::schemas::reg_c700::dsl)]
pub struct RegC700 {
    pub id: i32,
...
impl Model for RegC700 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegC700>, Error> {
...
impl_display_fields!(RegC700, [reg, cod_mod, ser, nro_ord_ini, nro_ord_fin, dt_doc_ini, dt_doc_fin, nom_mest, chv_cod_dig]);
