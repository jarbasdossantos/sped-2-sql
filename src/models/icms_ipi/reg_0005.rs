...
use crate::schemas::reg_0005::dsl as schema;
use crate::schemas::reg_0005::table;
...
#[diesel(table_name = crate::schemas::reg_0005::dsl)]
pub struct Reg0005 {
    pub id: i32,
...
impl Model for Reg0005 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<Reg0005>, Error> {
...
impl_display_fields!(Reg0005, [reg, fantasia, cep, endereco, num, compl, bairro, fone, fax, email]);
