...
use crate::schemas::reg_g140::reg_g140::dsl as schema;
use crate::schemas::reg_g140::reg_g140::table;
...
#[diesel(table_name = crate::schemas::reg_g140::reg_g140::dsl)]
pub struct RegG140 {
    pub id: i32,
...
impl Model for RegG140 {
    ...
    async fn get(file_id: i32, parent_id: Option<i32>) -> Result<Vec<RegG140>, Error> {
