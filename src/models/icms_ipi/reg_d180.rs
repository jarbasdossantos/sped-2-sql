...
use crate::schemas::reg_d180::dsl as schema;
use crate::schemas::reg_d180::table;
...
#[diesel(table_name = crate::schemas::reg_d180::dsl)]
pub struct RegD180 {
    pub id: i32,
...
impl Model for RegD180 {
    ...
    fn get(file_id: i32, parent_id: Option<i32>, conn: &mut SqliteConnection) -> Result<Vec<RegD180>, Error> {
...
impl_display_fields!(RegD180, [reg, num_seq, ind_emit, cnpj_cpf_emit, uf_emit, ie_emit, cod_mun_orig, cnpj_cpf_tom, uf_tom, ie_tom, cod_mun_dest, cod_mod, ser, sub, num_doc, dt_doc, vl_doc]);
