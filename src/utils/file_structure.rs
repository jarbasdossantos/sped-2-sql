...
use crate::models::{
    piscofins::reg_0000::Reg0000,
    piscofins::reg_0001::Reg0001,
    piscofins::reg_0035::Reg0035,
    piscofins::reg_0140::Reg0140,
    piscofins::reg_0150::Reg0150,
    piscofins::reg_0190::Reg0190,
    piscofins::reg_0200::Reg0200,
    piscofins::reg_0400::Reg0400,
    piscofins::reg_0500::Reg0500,
    piscofins::reg_9999::Reg9999,
    piscofins::reg_c001::RegC001,
    piscofins::reg_c010::RegC010,
    piscofins::reg_c180::RegC180,
    piscofins::reg_c181::RegC181,
    piscofins::reg_c185::RegC185,
    piscofins::reg_p200::RegP200,
    traits::{Model, Reg},
};
    ...
    IndexMap::from([
        ...
        (
            ...
            Struct {
                level: 3,
                load_model: Some(|file_id, parent_id| {
                    Box::pin(load_model_helper::<Reg0400>(file_id, parent_id))
                }),
            },
        ),
        (
